...
| Every CLI command, its flags, `--json`, and when it asks for confirmation | `https://fillo.so/docs/cli/reference.md` |
| MCP capabilities, approval links, and the tool inventory | `https://fillo.so/docs/mcp/actions.md` |
